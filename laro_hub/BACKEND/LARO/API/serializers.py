...
class NotificationSerializer(serializers.ModelSerializer):
    """
    NotificationSerializer handles the conversion of Notification model instances to/from JSON format.

    Features:
    - Converts Notification model data to JSON for API responses
    - Includes formatted timestamp for easier frontend display
    - Includes the notification type display name
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_read', 'created_at', 'formatted_timestamp',
            'related_object_id', 'related_object_type', 'data'
        ]
        read_only_fields = ['id', 'created_at', 'formatted_timestamp']

    def get_formatted_timestamp(self, obj):
        """
        Format the timestamp for frontend display
        """
